...
import { MdLightMode, MdDarkMode, MdTranslate, MdDescription, MdArrowBack } from 'react-icons/md';
      ...
      <main id="main-content" className="max-w-md w-full text-center p-8">
        <div className="mb-6 flex justify-center">
          <div className="p-4 rounded-full bg-warning/10 dark:bg-warning/20">
            <MdDescription className="h-16 w-16 text-warning dark:text-warning" />
          </div>
        </div>
        ...
        <p className="text-text-secondary dark:text-zinc-400 mb-8">{t('error.notFoundDesc')}</p>
        <button
